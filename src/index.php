...
<body>
    ...
    <main>
        ...
        <section class="section portfolio">
            <div class="container">
                    <h2 class="section-title portfolio__title wow zoomInDown" data-wow-delay="0.1s">Работая с 2007 года, <br>мы сделали более 500 ремонтов в квартирах и домах</h2>
                <div class="slider">
            ...
            <div class="container">
                ...
                <div class="cards">
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.1s">
                        <div class="card__image"><img src="img/price/bathroom.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                    ...
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.2s">
                        <div class="card__image"><img src="img/price/living.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                        <div class="card__text">
                    ...
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.3s">
                        <div class="card__image"><img src="img/price/office.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                        <div class="card__text">
                    ...
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.4s">
                        <div class="card__image"><img src="img/price/buildings.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                        <div class="card__text">
                    ...
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.5s">
                        <div class="card__image"><img src="img/price/kitchen.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                        <div class="card__text">
                    ...
                    <div class="card price__card wow fadeInUp" data-wow-delay="0.6s">
                        <div class="card__image"><img src="img/price/house.png" class="card__img" alt=""></div>
                        <!-- /.card__image -->
                        <div class="card__text">
        ...
        <section class="section info">
            <div class="container">
                <h2 class="section__title info__title">Ремонт обойдется Вам дешевле, так как<br>мы используем качественные материалы по оптовым ценам</h2>
            ...
            <div class="container">
                ...
                <div class="contracts">
                    <div class="contract guarantee-contact">
                        <div class="contract__box">
                            <div class="contract__frame">
                                <img class="contract__image" src="img/guarantee/contract-1.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="contract guarantee-contact">
                        <div class="contract__box">
                            <div class="contract__frame">
                                <img class="contract__image" src="img/guarantee/contract-2.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="contract guarantee-contact">
                        <div class="contract__box">
                            <div class="contract__frame">
                                <img class="contract__image" src="img/guarantee/contract-3.png" alt="">
                            </div>
                        </div>
        ...
        <div class="footer-block">
            <div class="map" id="map">
                <script type="text/javascript" charset="utf-8" async
                    src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A73a3d48550375806ad864a8b6d998df2fbcf13f0db32d5f9ce59563ab3773b44&amp;width=100%25&amp;height=640&amp;lang=ru_RU&amp;scroll=false"></script>
            </div>
            <div class="container">
